...
<body class="bg-zinc-950 text-zinc-100 font-sans">
    ...
    <nav class="glass sticky top-0 z-50 flex items-center justify-between px-8 py-2 border-b border-zinc-800 gap-6">
        <a href="knetflex" class="text-2xl font-black text-red-600 hover:text-red-700 transition-colors duration-300 ease-in-out tracking-tighter italic shrink-0">Czestflix3</a>
    ...
    <nav class="nav-overlay p-8 flex flex-col items-center justify-between">
        <div class="text-3xl font-black text-red-600 tracking-tighter">CZESTFLIX</div>
    ...
    <header class="py-16 px-8 text-center">
        <h1 class="text-5xl font-bold mb-4">Personal Archive</h1>
