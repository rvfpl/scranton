...
$page_data = [
    ...
    'spotlight' => [
        ...
        'aliases'     => "Native, Fanta, Robbo, ElBoberino, GandalfTheWiseguy, MC BO!",
...
<section style="margin-bottom:4rem; margin-top: 2rem;">
   <div class="label uppercase" style="text-align: center; margin-bottom: 0.5rem;">DISCOVER</div>
   <h2 style=" font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 800; letter-spacing: -0.02em; margin: 0.4rem 0 0.25rem; line-height: 1.05; 
   text-align: center; ">
              NEW YORK: BEST  STARTUPS  & DEVS
   </h2>
 
<div class="label " style="text-align: center; margin-bottom: 0.5rem;">JUNE 2026</div>
    ...
    <section id="tab-spotlight" class="tab-panel">
        ...
        <header class="reveal reveal--1 " style="margin-bottom: 1rem; ">
        ...
        <a href="{{ $b['url'] }}" class="site-banner reveal reveal--3" style="--banner-img: url('{{ $b['image'] }}')"
