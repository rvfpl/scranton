...
<div class="inline-flex items-center gap-2 sticky-note rounded-md px-4 py-2 text-sm font-semibold rotate-[-1deg] mb-4">
  ...
  <h1 class="text-4xl sm:text-5xl lg:text-4xl font-extrabold tracking-tight leading-tight text-gray-900">
The Scranton Branch  of </h1>
<h2 class="text-3xl sm:text-4xl lg:text-6xl font-extrabold tracking-tight leading-tight text-gray-900"> Software Engineering </h2>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-2xl font-extrabold text-gray-900">Featured & Latest Developer Jobs</h2>
                <p class="text-gray-600 mt-1">Assistant <strike>to the </strike> Regional Manager Curated positions without applicant metrics distortion.</p>
            </div>
        ...
        <div x-show="fetchError" x-cloak class="text-center py-12 paper-card rounded-3xl mb-6 bg-red-50/50 border-red-200">
            <span class="text-xl">⚠️</span>
            <h4 class="font-bold text-gray-900 mt-2">Failed to sync index</h4>
            <p class="text-gray-600 text-sm">Could not hook data layers from internal endpoints.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-start">
                ...
                <div class="paper-card job-card rounded-3xl p-6 transition flex flex-col gap-4">
                    <div class="flex flex-col h-full justify-between gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-3 text-gray-500 text-sm leading-relaxed max-w-xl"
                               x-text="job.description.length > 120 ? job.description.substring(0, 120) + '…' : job.description"></p>
            ...
            <div x-show="filteredJobs().length === 0" x-cloak class="col-span-full text-center py-16 paper-card rounded-3xl">
                <div class="text-4xl mb-3">📭</div>
                <h4 class="font-bold text-lg text-gray-900">No matches found</h4>
                <p class="text-gray-500 text-sm mt-1">Try adjusting your keywords or clearing out your active filters.</p>
