    ...
    <div class="flex items-center justify-between h-full px-4 gap-3">
        <a href="/" class="flex items-center gap-2 flex-shrink-0">
            <div style="background:#1a2e1a;border:1px solid rgba(74,222,128,0.3);width:32px;height:32px;border-radius:6px;display:flex;align-items:center;justify-content:center">
                <span style="font-family:'IBM Plex Mono',monospace;font-size:10px;font-weight:600;color:#4ade80">SD</span>
            </div>
            <span style="font-family:'IBM Plex Mono',monospace;font-size:14px;font-weight:600">scranton<span style="color:var(--accent)">.dev</span></span>
        </a>
