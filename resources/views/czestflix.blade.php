...
<head>
    ...
    <title>czestflix | Curated Curation</title>
...
<body class="bg-zinc-950 text-zinc-100 font-sans">
    ...
    <nav class="glass sticky top-0 z-50 flex items-center justify-between px-8 py-4 border-b border-zinc-800 gap-6">
        <a href="czestflix" class="text-2xl font-black text-red-600 hover:text-red-700 transition-colors duration-300 ease-in-out tracking-tighter italic shrink-0">CZESTFLIX</a>
    ...
    <!-- Hero Promo Section -->
    <section class="relative w-full h-[36vh] flex items-center justify-center overflow-hidden border-b border-zinc-800">
