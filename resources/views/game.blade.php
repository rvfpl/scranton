...
<body>
    ...
    <!-- ════════════════════════════════ NAV ════════════════════════════════ -->
<nav class="topnav" style="z-index:999;position:absolute;top:0;left:0;right:0;background:rgba(0,0,0,0.1);border-bottom:1px solid #0f3"> 
 
        <a href="/" class="flex items-center gap-2 flex-shrink-0">
            <div style="background:#;border:1px solid rgba(13, 32, 49,0.8);height:32px;border-radius:6px;display:flex;align-items:center;justify-content:center">
                <span style="font-family:'IBM Plex Mono',monospace;font-size:10px;font-weight:600;color:white;">newyork.dev</span>
            </div>
         </a>
...
<div id="screen-wrap">
    ...
    <div id="all-jobs-modal">
        ...
        <a href="https://newyork.dev/jobs">    <button class="btn btn-red" onclick="AllJobs.hide()">JOBS</button> </a>
        </div>
    </div>
...
/* ──────────────────────────────────────────────────────
   0. DUMMY JOB DATA
   Replace with: const JOB_DATA = {!! json_encode($jobs) !!};
