...
<head>
    ...
    <title>nyvid | Curated Curation</title>
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' fill='%23121212'/><text x='50%' y='50%' dominant-baseline='central' text-anchor='middle' font-family='sans-serif' font-weight='bold' font-size='60' fill='red'>NY</text></svg>">
...
<body class="bg-zinc-950 text-zinc-100 font-sans">
    ...
    <!-- Navigation -->
    <nav class="glass sticky top-0 z-50 flex items-center justify-between px-8 py-2 border-b border-zinc-800 gap-6">
        <a href="nyvid" class="text-2xl font-black text-red-600 hover:text-red-700 transition-colors duration-300 ease-in-out tracking-tighter italic shrink-0">Nyvid</a>

        <!-- Search bar (desktop, in-nav) -->
        <div class="search-wrap block flex-1 max-w-md">
    ...
    <nav class="nav-overlay p-8 flex flex-col items-center justify-between">
        <div class="text-3xl font-black text-red-600 tracking-tighter">nyFLIX</div>
    ...
    <!-- Hero Promo Section -->
    <section id="hero" class="relative w-full h-[40vh] flex items-end justify-start overflow-hidden border-b border-zinc-800 bg-black">
    ...
    <header class="py-16 px-8 text-center">
        <h1 class="text-5xl font-bold mb-4 hidden md:block">Personal Archive</h1>
        <p class="text-zinc-500">The specific stuff I like, hosted nowhere near a corporate server.</p>
    </header>

    <!-- Grid -->
    <main class="max-w-7xl mx-auto px-6 pb-20">
        <div id="video-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <footer class="py-10 border-t border-zinc-900 text-center text-zinc-600 text-xs">
        <p class="mb-2 uppercase tracking-widest">czestflix &copy; 2026</p>
