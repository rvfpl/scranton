...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' fill='%23121212'/><text x='50%' y='50%' dominant-baseline='central' text-anchor='middle' font-family='sans-serif' font-weight='bold' font-size='60' fill='red'>K</text></svg>">
...
<body class="bg-zinc-950 text-zinc-100 font-sans">
    ...
    <nav class="glass sticky top-0 z-50 flex items-center justify-between px-8 py-4 border-b border-zinc-800 gap-6">
        <a href="knetflex" class="text-2xl font-black text-red-600 hover:text-red-700 transition-colors duration-300 ease-in-out tracking-tighter italic shrink-0">KNETFLEX2</a>
    ...
    <!-- Hero Promo Section -->
    <section class="relative w-full h-[60vh] flex items-center justify-center overflow-hidden border-b border-zinc-800">
        ...
        <div class="relative z-20 text-center px-4"></div>
    </section>
