        ...
        <div class="mt-10 grid sm:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <ul class="text-gray-600 text-sm leading-relaxed space-y-1">
                    <li>• University of Scranton</li>
                                        <img src="img/sc3.jpg" alt="Downtown Scranton" class="mt-4 rounded-lg border border-black/10 shadow-sm">
                                        <img src="img/sc3b.jpg" alt="Downtown Scranton" class="mt-4 rounded-lg border border-black/10 shadow-sm">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm leading-relaxed">
                    ...
                    responsible cousin who owns a reliable Subaru.
                </p>
            </div>
